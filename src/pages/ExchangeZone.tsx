  ...
  return <div className="min-h-screen bg-gray-50 max-w-sm mx-auto">
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="flex space-x-3">
          <Button variant="outline" className="flex-1 py-3 text-yellow-brand border-yellow-brand hover:bg-yellow-light">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {exchangeGroups.map(group => <div key={group.id} className="bg-white rounded-lg border border-gray-200 p-4 cursor-pointer hover:shadow-md transition-shadow" onClick={() => handleCollectionClick(group.id)}>
