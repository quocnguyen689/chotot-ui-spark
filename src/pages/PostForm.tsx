...
import { Collection, CollectionCreate } from "@/services/marketplace.service";
...
const PostForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    // try {
    //   await DataService.create<Collection, CollectionCreate>(
    //     "ads", // endpoint (sẽ nối vào URL base)
    //     {
    //       title,
    //       description,
      ...
      <div className="p-4 space-y-6 py-[16px] pb-32">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div className="mt-2 text-sm text-gray-900">
            Giải trí, Thể thao, Sở thích - Sách
          </div>
        </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="relative aspect-square rounded-lg overflow-hidden">
                <img
                  ...
                  src="/lovable-uploads/8bb782bc-9971-4492-a1bd-566fb74c9978.png"
              ...
              <div className="relative aspect-square rounded-lg overflow-hidden">
                <img
                  alt="Uploaded product"
                  src="/lovable-uploads/472fd08c-ec7e-4d0d-be6e-295b8963125a.png"
        ...
        {formData.postType !== "giveaway" && (
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <Label className="text-gray-600 mb-3 block">
              Giá {formData.postType === "sale" ? "bán" : "tham khảo"}{" "}
              <span className="text-red-500">*</span>
            </Label>
            <Input
              type="text"
              ...
              placeholder={`Nhập giá ${
                formData.postType === "sale" ? "bán" : "tham khảo"
              }`}
            />
          </div>
        )}
